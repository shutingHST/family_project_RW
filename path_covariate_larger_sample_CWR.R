...
cwr~ a*cpa + b*cma + c*ran + d*nwr + e*vwm+hlp+Q19_P_Edu+Age_Months+gender_p
...
fit6_1 <- sem(model4_path, data = data_parent_children,se = "bootstrap",cluster = "FID",
            bootstrap = 2000)
summary(fit6_1, fit.measures = TRUE, standardized = TRUE)